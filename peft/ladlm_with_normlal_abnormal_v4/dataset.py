...
class CustomDataCollator:
    ...
    def __call__(self, samples):
        ...
        for sample in samples:
            ...
            # 설명 텍스트에서 불필요한 줄바꿈 제거
            explanation_about_spectrogram = re.sub(r'\n+', '\n', explanation_about_spectrogram).strip()
                    ...
                    "content": [
                        {"type": "image"},
                        {
                            ...
                            "text": (
                                ...
                                f"Explanation about spectrogram Detection anomaly:\n"
                                f"---\n"
                            )
                        }
                    ]
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": (
                                f"{explanation_about_spectrogram}\n"
                                f"result (anomaly or normal): {label}\n"
                            )
                        }
                    ]
                }
