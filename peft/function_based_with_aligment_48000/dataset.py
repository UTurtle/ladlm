...
class CustomDataCollator:
    ...
    def __call__(self, samples):
        ...
        for sample in samples:
            ...
            explanation = sample['function_based_explanation_spectrogram']
            dialog = [
                {
                    "role": "user",
                    "content": [
                        ...
                        {"type": "text",
                         "text": 
                            f"This is an image extracted using the Short-Time Fourier Transform (STFT) with librosa.\n"
                            f"This spectrogram can make this parameter :\n"
                        }
                    ],
                },
                {
            ...
            images.append([spectrogram_no_axes])
